...
public class CodeMsg {
	...
	public static CodeMsg HOME_ORDER_PAYMODE_ERROR = new CodeMsg(-13008, "没有选择支付方式！");
	public static CodeMsg HOME_ORDER_SCORE_ERROR = new CodeMsg(-13009, "积分不足，请先到会员中心充值！");
}
