                ...
                <ul>
                	<li class="wd">
                		<label class="account" style="width:370px;">
	                		<input type="radio" name="payment" id="balance" class="fn-left" data-paymethod="账户余额" data-payid="account" checked>
	                		<span class="fn-left">余额支付(可用余额：<em class="red" id="user-balance">${movie_account.balance}</em>元)</span>
                		</label>
                	</li>
                    <li class="wd">
                        <label class="account" style="width:370px;">
                            <input type="radio" name="payment" id="score" class="fn-left" data-paymethod="账户积分" data-payid="account" checked>
                            <span class="fn-left">积分支付(可用积分：<em class="red" id="user-score">${movie_account.score}</em>)</span>
                        </label>
                    </li>
                </ul>
            </div>
...
$(document).ready(function(){
    ...
    $("#btnpay").click(function(){
    	...
    	ajaxRequest('order_pay','post',{order_sn:'${order.sn}',payway:paymode},function(rst){
