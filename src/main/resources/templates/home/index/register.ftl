...
<div class="wrapper-register fn-clear">
    <div class="box-register">
        ...
        <p class="box-des fn-clear">
            <label class="cor999"><input type="checkbox" checked="checked" class="fn-left agreement" /><span class="fn-left">阅读并接受星光影院售票系统<a href="/help/serviceterms.html" target="_blank">《用户协议》</a></span></label>
            <span class="error">请接受星光影院售票系统《用户协议》</span>
        </p>
    </div>
