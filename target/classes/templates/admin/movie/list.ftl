                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">
                        	<#if movie.typeList??>
                        		...
                        		<span class="tag" style="float:left;padding:2px 5px;background:#ad916c;color:#fff;margin-right:5px;margin-bottom:5px;font-size:13px;line-height:18px;"><span>${type.getName()}</span></span>
                        		</#list>
                        	</#if>
                        </td>
                        <td style="vertical-align:middle;">
