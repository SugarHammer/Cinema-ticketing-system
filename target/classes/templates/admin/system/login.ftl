...
.login-center .has-feedback.feedback-left.row .form-control-feedback {
  ...
  <body style="background: url('https://i.gtimg.cn/qqlive/img/jpgcache/files/qqvideo/hori/m/midxpxx4wbn0o8z.jpg');background-size: cover">
<div class="row lyear-wrapper">
<#--  <img style="margin: 140px;height: 600px;float: left;" src="../../../static/home/images/22.png"/>-->
<#--  <img style="margin: 140px;height: 600px;float: left;" src="https://ts1.cn.mm.bing.net/th/id/R-C.4d0601b44accae38ff8a495a545e0124?rik=vTgkqx97fuhsCA&riu=http%3a%2f%2fimg.sj33.cn%2fuploads%2fallimg%2f201212%2f20121211131906373.png&ehk=2FcDSWBrl9bKBfiNQZTUEyvRTswdwwuGCbN9z4%2fhZLA%3d&risl=&pid=ImgRaw&r=0"/>-->
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href=""style="color:red;font-size: 30px">星光影院售票系统</a>
      </div>
